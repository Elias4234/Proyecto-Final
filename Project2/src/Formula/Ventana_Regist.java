...
public class Ventana_Regist extends JFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					Ventana_Regist frame = new Ventana_Regist();
	...
	public Ventana_Regist() {
			...
			public void actionPerformed(ActionEvent e) {
				validarRegistro();
				 ...
				 public void validarRegistro(){
						...
						if(txtId.getText().isEmpty() || txtNombre.getText().isEmpty() || txtApellido.getText().isEmpty() || txtUsuario.getText().isEmpty() 
		...
		btnNewButton.setBounds(38, 425, 134, 32);
		...
		btnNewButton_1.setBounds(216, 426, 128, 32);
